...
function aksvb_enqueue() {
	...
	wp_enqueue_script( 'aksvb-bxslider', AKSVB_THEME_JS . 'vendor/owl.carousel.min.js', array('aksvb-jquery'), AKSVB_THEME_VERSION, true );
	wp_enqueue_script( 'aksvb-tablesaw', AKSVB_THEME_JS . 'vendor/tablesaw.stackonly.js', array('aksvb-jquery'), AKSVB_THEME_VERSION, true );

	// Google maps
	//wp_enqueue_script( 'gmaps', 'http://maps.google.com/maps/api/js', array(), AKSVB_THEME_VERSION, true );
	//wp_enqueue_script( 'aksvb-gmaps', AKSVB_THEME_JS . 'vendor/gmaps.min.js', array( 'gmaps' ), AKSVB_THEME_VERSION, true );
